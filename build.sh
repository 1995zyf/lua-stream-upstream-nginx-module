...
function build_debug() {
  ...
  ./configure --prefix="$INSTALL_PREFIX/nginx-$VERSION" \
              ...
              --add-module=../lua-stream-upstream-nginx-module > /dev/null 2>/dev/stderr
...
function download() {
  ...
  download_module openresty   lua-upstream-nginx-module        master
  download_module ZigzagAK    lua-stream-upstream-nginx-module master
